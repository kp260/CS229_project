...
def train_sess(sess, model_spec, num_steps, writer, params, model_dir):
    ...
    metrics_string = " ; ".join("{}: {:05.3f}\n".format(k, v) for k, v in metrics_val.items())
...
def train_and_evaluate(train_model_spec, eval_model_spec, model_dir, params, restore_from=None):
    ...
    with tf.Session() as sess:
        ...
        sess.run(train_model_spec['variable_init_op'], options = run_options)
        ...
        for epoch in range(begin_at_epoch, begin_at_epoch + params.num_epochs):
            ...
            num_steps = (params.m1*15*params.class_num + params.batch_size - 1) // params.batch_size
